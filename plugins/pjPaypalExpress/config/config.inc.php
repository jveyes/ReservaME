<?php
$config = array();
$config['PLUGIN_NAME'] = 'pjPaypalExpress';
$config['PLUGIN_MODEL'] = 'pjPaypalExpressModel';
...
$config['PLUGIN_ID'] = "308";
$config['PLUGIN_VERSION'] = "2.0";
$config['PLUGIN_BUILD'] = "2.0.2";
...
$plugins[$config['PLUGIN_NAME']] = array('pjPaypalExpress');
