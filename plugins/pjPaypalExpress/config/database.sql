...
INSERT INTO `fields` (`id`, `key`, `type`, `label`, `source`) VALUES
  (NULL, 'payment_methods_ARRAY_paypal_express', 'arrays', 'payment_methods_ARRAY_paypal_express', 'plugin');
...
INSERT INTO `fields` (`id`, `key`, `type`, `label`, `source`) VALUES
  (NULL, 'plugin_paypal_express_payment_title', 'frontend', 'PayPal Express Checkout plugin / Payment title', 'plugin');
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `multi_lang` (`id`, `foreign_id`, `model`, `locale`, `field`, `content`, `source`) VALUES
...
INSERT INTO `fields` VALUES (NULL, 'payment_plugin_messages_ARRAY_paypal_express', 'arrays', 'payment_plugin_messages_ARRAY_paypal_express', 'plugin', NULL);
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `multi_lang` VALUES (NULL, @id, 'pjField', '::LOCALE::', 'title', 'Your order is saved. Redirecting to PayPal Express Checkout...', 'plugin');
