...
<div class="form-group hidden-area" style="display: <?php echo $tpl['arr']['is_active'] == '1' ? 'block' : 'none'; ?>">
    <label class="control-label col-lg-4"><?php __('plugin_paypal_merchant_email'); ?></label>

    <div class="col-lg-8">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-at"></i></span>
            <input type="text" name="plugin_payment_options[paypal][merchant_email]" value="<?php echo pjSanitize::html(@$tpl['arr']['merchant_email']); ?>" class="form-control required">
        </div>
        <p class="small"><?php __('plugin_paypal_merchant_email_text'); ?></p>
    </div><!-- /.col-lg-8 -->
</div><!-- /.form-group -->