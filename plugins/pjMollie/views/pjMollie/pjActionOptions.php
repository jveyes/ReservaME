...
<div class="form-group hidden-area" style="display: <?php echo $tpl['arr']['is_active'] == '1' ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <input type="text" name="plugin_payment_options[mollie][public_key]" value="<?php echo pjSanitize::html(@$tpl['arr']['public_key']); ?>" class="form-control required">
...
<div class="form-group hidden-area" style="display: <?php echo $tpl['arr']['is_active'] == '1' ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <div class="input-group">
            ...
            <input type="text" name="plugin_payment_options[mollie][failure_url]" value="<?php echo pjSanitize::html(@$tpl['arr']['failure_url']); ?>" class="form-control required">
        </div>
    </div><!-- /.col-lg-8 -->
</div><!-- /.form-group -->