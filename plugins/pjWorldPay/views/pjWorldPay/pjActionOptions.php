        ...
        <div class="switch m-t-xs">
            <div class="onoffswitch onoffswitch-data">
                ...
                <label class="onoffswitch-label" for="enablePayment">
                    <span class="onoffswitch-inner" data-on="<?php __('plugin_worldpay_yesno_ARRAY_T', false, true);?>" data-off="<?php __('plugin_worldpay_yesno_ARRAY_F', false, true);?>"></span>
		...
		<div class="col-lg-8">
			...
			foreach ($tpl['lp_arr'] as $v)
			{
				...
				<input 
					...
					name="i18n[<?php echo $v['id']; ?>][world_pay]" 
					value="<?php echo pjSanitize::html(@$tpl['i18n'][$v['id']]['world_pay']); ?>">
				<?php
			}
			?>
			</div>
...
<div class="form-group hidden-area" style="display: <?php echo $tpl['arr']['is_active'] == '1' ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <input type="text" name="plugin_payment_options[world_pay][merchant_id]" value="<?php echo pjSanitize::html(@$tpl['arr']['merchant_id']); ?>" class="form-control required">
...
<div class="form-group hidden-area" style="display: <?php echo $tpl['arr']['is_active'] == '1' ? 'block' : 'none'; ?>">
    ...
    <div class="col-lg-8">
        <input type="text" name="plugin_payment_options[world_pay][private_key]" value="<?php echo pjSanitize::html(@$tpl['arr']['private_key']); ?>" class="form-control required">
