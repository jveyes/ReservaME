...
<img src="https://citas.jmvb.co/wp-content/uploads/2020/05/SuLogotipo.png" alt="JMVB" width="150">
            ...
            <?php if($login_2_factor == 'No' || $second_factor == true): ?>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" name="login_password" id="login_password" class="form-control form-control-lg required" placeholder="Contraseña" autocomplete="off" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                    </div>
